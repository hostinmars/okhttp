...
public class Http20Draft12Test {
  ...
  @Test public void readPaddedDataFrameWithTooMuchPadding() throws IOException {
    ...
    try {
      ...
      assertEquals("PROTOCOL_ERROR padding > Http20Draft12.MAX_FRAME_SIZE: 65535", e.getMessage());
    }
  }
  ...
  @Test public void tooLargeDataFrame() throws IOException {
    try {
      ...
      assertEquals("FRAME_SIZE_ERROR length > Http20Draft12.MAX_FRAME_SIZE: 16777216", e.getMessage());
    }
  }
  ...
  @Test public void frameSizeError() throws IOException {
    ...
    try {
      ...
      assertEquals("FRAME_SIZE_ERROR length > Http20Draft12.MAX_FRAME_SIZE: 16384", e.getMessage());
    }
  }
